...
struct TextPool_en_t
{
    ...
    char AppWaveform_Fault_CleanupPending[22] = "Shutdown not complete";
    char AppWaveform_Fault_PowerCycle[23] = "Power-cycle the device";
    char AppWaveform_Fault_Ack[17] = "Encoder: Confirm";
