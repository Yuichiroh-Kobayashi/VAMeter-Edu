...
struct TextPool_cn_t
{
    ...
    char AppWaveform_Fault_StoppedForSafety[16] = "录制已退出";
    char AppWaveform_Fault_OutputOff[12] = "输出: OFF";
    char AppWaveform_Fault_OutputUnconfirmed[10] = "输出: ?";
    char AppWaveform_Fault_PowerOff[10] = "请关闭";
    char AppWaveform_Fault_CleanupPending[13] = "没有完成";
    char AppWaveform_Fault_PowerCycle[13] = "马上重启";
