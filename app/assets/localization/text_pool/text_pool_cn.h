...
struct TextPool_cn_t
{
    ...
    char AppWaveform_Fault_StoppedForSafety[25] = "为安全已停止测量";
    char AppWaveform_Fault_OutputOff[12] = "输出: OFF";
    char AppWaveform_Fault_OutputUnconfirmed[28] = "无法确认输出已关闭";
    char AppWaveform_Fault_PowerOff[16] = "请关闭电源";
    char AppWaveform_Fault_CleanupPending[22] = "停止处理未完成";
    char AppWaveform_Fault_PowerCycle[16] = "请重新开机";
    char AppWaveform_Fault_Ack[16] = "Encoder: 确认";
